...
/******************************************************************************/
#define AI_CNNDQN_MODEL_NAME          "cnndqn"
#define AI_CNNDQN_ORIGIN_MODEL_NAME   "cnndqn_for_match3"

/******************************************************************************/
#define AI_CNNDQN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CNNDQN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CNNDQN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CNNDQN_IN_NUM        (1)

AI_DEPRECATED
#define AI_CNNDQN_IN \
  ai_cnndqn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNNDQN_IN_SIZE { \
  AI_CNNDQN_IN_1_SIZE, \
}
#define AI_CNNDQN_IN_SIZE_BYTES { \
  AI_CNNDQN_IN_1_SIZE_BYTES, \
}
#define AI_CNNDQN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNNDQN_IN_1_HEIGHT      (4)
#define AI_CNNDQN_IN_1_WIDTH       (3)
#define AI_CNNDQN_IN_1_CHANNEL     (4)
#define AI_CNNDQN_IN_1_SIZE        (48)
#define AI_CNNDQN_IN_1_SIZE_BYTES  (192)

/******************************************************************************/
#define AI_CNNDQN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CNNDQN_OUT \
  ai_cnndqn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNNDQN_OUT_SIZE { \
  AI_CNNDQN_OUT_1_SIZE, \
}
#define AI_CNNDQN_OUT_SIZE_BYTES { \
  AI_CNNDQN_OUT_1_SIZE_BYTES, \
}
#define AI_CNNDQN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNNDQN_OUT_1_CHANNEL     (24)
#define AI_CNNDQN_OUT_1_SIZE        (24)
#define AI_CNNDQN_OUT_1_SIZE_BYTES  (96)

/******************************************************************************/
#define AI_CNNDQN_N_NODES (9)
 ...
 * @ref ai_cnndqn_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnndqn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnndqn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CNNDQN_*
 * defines into file @ref cnndqn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
